...
class GeneralPreferencesWidget(QWidget):
    ...
    def __init__(
        ...
        self.font_size_spin_box.setMaximum(128)
        ...
        # Custom OpenAI Whisper model name
        self.custom_openai_model = self.settings.value(
            key=Settings.Key.CUSTOM_OPENAI_MODEL, default_value=""
        )
        self.custom_openai_model_line_edit = LineEdit(self.custom_openai_model, self)
        self.custom_openai_model_line_edit.textChanged.connect(self.on_custom_openai_model_changed)
